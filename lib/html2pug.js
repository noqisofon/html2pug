var fs, path, jsdom, Ent, metaDebug, debug, entOptions, tabWidth, useTabs, doNotEncode, validPugIdRe, validPugClassRe, Parser, Writer, publicIdDoctypeNames, systemIdDoctypeNames, Converter, Output, StringOutput, StreamOutput, applyOptions, convert, convertHtml, convertDocument, out$ = typeof exports != 'undefined' && exports || this;
fs = require('fs');
path = require('path');
jsdom = require('jsdom');
Ent = require('he');
  ...
  Converter.prototype.writeComment = function(node, output){
    ...
    if (!condition) {
      ...
      if (data.length === 0 || data.search(/\r|\n/) === -1) {
        ...
        self = this;
        lines.forEach(function(line){
          return self.writer.writeTextLine(node, line, output, {
            pipe: false,
            trim: true,
            wrap: false
          });
